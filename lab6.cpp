...
bool operator ==(Student& s1){
        ...
        for(int i=0; i<s1.nrNote;i++)
            medie_note1=medie_note1+s1.note[i];
        medie_note1=medie_note1/s1.nrNote;


        if(medie_note1==medie_note)
            {return true;}
        else
           {return false;}
...
cout<<s1.medieStudent();
cout<<endl;
Student s11(s1);

//s3=s3+10;
cout<<s3.medieStudent();
    if(s1==s3)
        cout<<"\n Sunt egali\n";
    else
        cout<<"\n NU \n ";
